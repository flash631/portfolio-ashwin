        ...
        <Reveal>
          <div className="space-y-6">
            ...
            <div className="text-lg text-slate-600 dark:text-slate-200 max-w-xl leading-relaxed">
              Currently pursuing <strong className="text-slate-900 dark:text-white">Master of Engineering</strong> in <strong className="text-slate-900 dark:text-white">Aerospace Systems Engineering</strong>.
              <span className="block mt-2 opacity-90 text-slate-600 dark:text-slate-300">at the <strong className="text-slate-900 dark:text-white">University of Illinois Urbana-Champaign</strong></span>
            </div>

            <div className="flex flex-wrap gap-4 pt-6">
              <a 
                href="images/ashwin_cv.pdf" 
                download 
